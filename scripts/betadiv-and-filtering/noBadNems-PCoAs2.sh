...
#SBATCH --job-name="noBadNems-PCoAs2"
...
#SBATCH -e noBadNems-PCoAs2.err-%N
#SBATCH -o noBadNems-PCoAs2.out-%N
...
#Bray curtis, Canberra, and Jaccard analyses at 1000 seqs/sample rarefaction
beta_diversity_through_plots.py -i $BACBIOM \
	-m $BACMAP \
	-o $BACOTUS/div-analyses/NObadnems-bc-1000 \
	-p $PARAMS/params_braycurtis.txt \
	-e 1000
	
beta_diversity_through_plots.py -i $BACBIOM \
	-m $BACMAP \
	-o $BACOTUS/div-analyses/NObadnems-canberra-1000 \
	-p $PARAMS/params_canberra.txt \
	-e 1000

beta_diversity_through_plots.py -i $BACBIOM \
	-m $BACMAP \
	-o $BACOTUS/div-analyses/NObadnems-jaccard-1000 \
...
beta_diversity_through_plots.py -i $EUKBIOM \
	-m $EUKMAP \
	-o $EUKOTUS/div-analyses/NObadnems-bc-1000 \
	-p $PARAMS/params_braycurtis.txt \
	-e 1000
	
beta_diversity_through_plots.py -i $EUKBIOM \
	-m $EUKMAP \
	-o $EUKOTUS/div-analyses/NObadnems-canberra-1000 \
	-p $PARAMS/params_canberra.txt \
	-e 1000

beta_diversity_through_plots.py -i $EUKBIOM \
	-m $EUKMAP \
	-o $EUKOTUS/div-analyses/NObadnems-jaccard-1000 \
	-p $PARAMS/params_jaccard.txt \
	-e 1000

...
otu_metazoaRemoved <- import_biom("/Users/Taruna/Dropbox/bik_lab/MEmicrobiome/files-4-phyloseq/18S/otu_table_mc2_w_tax_BlankOTUsRemoved_BlankSamplesRemoved_NObadnems_noZeros_MetazoaRemoved-above-500-kept.biom")
otu_nemsRemoved <- import_biom("/Users/Taruna/Dropbox/bik_lab/MEmicrobiome/files-4-phyloseq/18S/otu_table_mc2_w_tax_BlankOTUsRemoved_BlankSamplesRemoved_NObadnems_noZeros_NemsRemoved_above-500-kept.biom")
...
plot_bar(physeq_metazoaRemoved_trans_trimmed, x = "Sample", y ="Abundance", fill = "Rank5")
...
plot_bar(physeq_nemsRemoved_trans_trimmed, x = "Sample", y ="Abundance", fill = "Rank2")
...
plot_bar(physeqtop10_metazoaRemoved, x = "Sample", y ="Abundance", fill = "Rank6")
